...
final class python_eZ80Project extends Project
{
    ...
    private python_eZ80ProjectBackend $backend;
    ...
    public function __construct($db_id, $pid, UserInfo $author, $type, $name, $internalName, $multiuser, $readonly, $chatEnabled, $cTime, $uTime)
    {
        ...
        $this->backend = new python_eZ80ProjectBackend($this, $this->projDirectory);

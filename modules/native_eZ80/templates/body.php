            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="modalSettingsBody">
                    <form class="form-horizontal" id="settingsForm" onsubmit="return false;">
                        ...
                        <!-- to put in a distinct modal, global to the PB, not CE C -->
                        <h4>Sharing mode</h4>
